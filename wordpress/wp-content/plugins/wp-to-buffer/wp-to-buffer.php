    ...
    public function __construct() {
        ...
        $this->plugin->upgrade_reasons = array(
            array(
                ...
                __( 'Post to Instagram (Reminders for Personal Profiles, Direct Posting to Business Profiles) and Pinterest Boards', $this->plugin->name ),
            ),
            array(
            ...
            array(
                ...
                __( 'Schedule Posts to Buffer based on your Event\'s Start or End date, as well as display Event-specific details in your status updates', $this->plugin->name ),
            ),
            array(
